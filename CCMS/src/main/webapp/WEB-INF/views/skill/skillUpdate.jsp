...
<div class="w3-container" style="padding-left: 15%; padding-right: 15%; padding-top: 5%;">
	<form action="${pageContext.request.contextPath}/skill/skillUpdateEnd.ski" method="post" onsubmit="return validate1();">
		<div class="w3-row-padding">
	        ...
	        <div class="w3-row" style="padding-top: 12%;">
	        	<textarea class="form-control" id="summernote" name="content" style="width: 100%; height: 400px;" required>${skill.content}</textarea>
	        </div>
