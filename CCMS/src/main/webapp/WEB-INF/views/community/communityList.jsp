	...
	<div class="w3-container" style="padding-left: 15%; padding-right: 15%; padding-top: 4%;">
        <div class="w3-row">
        	...
        	<div class ="w3-col m10" style="padding-left:2%; border-left: 5px solid orange;">
	            ...
	            <form action="${pageContext.request.contextPath}/community/communitySearch.comu" method="get" onsubmit="return validate1();">
	            ...
	            %>
		        <%= com.kh.ccms.common.util.Utils.getPageBar(totalContents, cPage, numPerPage, "community.comu") %>       
        	</div>
        </div>
    </div>
