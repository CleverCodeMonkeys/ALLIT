...
<div class="w3-container" style="padding-left: 15%; padding-right: 15%; padding-top: 5%;">
	<form action="${pageContext.request.contextPath}/community/communityInsert.comu" method="post" onsubmit="return validate1();">
		<div class="w3-row-padding">
			<div class="w3-col s2 w3-center">
				<div class="w3-col"><h5>제목</h5></div>
	        </div>
	        <div class="w3-col s10 w3-center">
	            <input class="w3-input w3-border w3-hover-border-red" type="text" id="title" name="title">
	        </div>
	        ...
	        <div class="w3-row" style="padding-top: 12%;">
	        	<textarea class="form-control" id="summernote" name="content" style="width: 100%; height: 400px;" required></textarea>
	        </div>
